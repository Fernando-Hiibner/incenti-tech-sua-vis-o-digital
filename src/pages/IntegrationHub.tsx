...
import { getIntegrationHubPath, integrationHubPaths } from "@/lib/integrationHubRoutes";
...
import logoNexus from "@/assets/integration-hub/logo-nexus.png";
  ...
  return (
    <div className="integration-hub-theme min-h-screen bg-background text-foreground">
      <SeoHead
        ...
        canonical={canonical}
        lang={locale}
        ogLocale={page.seo.ogLocale}
        keywords={page.seo.keywords}
        alternates={[
          { hrefLang: "pt-BR", href: `https://incentitech.com.br${integrationHubPaths["pt-BR"]}` },
          { hrefLang: "en", href: `https://incentitech.com.br${integrationHubPaths.en}` },
          { hrefLang: "x-default", href: `https://incentitech.com.br${integrationHubPaths.en}` },
        ]}
      />
        ...
        <div className={`container mx-auto flex items-center justify-between px-6 transition-all duration-300 ${scrolled ? "h-14" : "h-20"}`}>
          <div className="flex items-center gap-3">
            <div className={`rounded-lg transition-all duration-300 ${scrolled ? "p-1" : "p-2"}`}>
              <img src={logoNexus} alt="Integration Hub" className={`object-contain transition-all duration-300 ${scrolled ? "h-8 w-8" : "h-14 w-14"}`} />
            </div>
      ...
      <section className="relative flex min-h-screen items-center justify-center overflow-hidden pt-24 md:pt-20">
        <div className="absolute inset-0">
          <img src="https://images.unsplash.com/photo-1521737604893-d14cc237f11d?auto=format&fit=crop&w=1920&q=80" alt="Integration Hub" className="h-full w-full object-cover" />
